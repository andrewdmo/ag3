...
export default class QCForm extends Component {
                        ...
                        <table>
                            ...
                            <tr className={this.state.unbucked ? 'row' : 'row hidden'}>
                                ...
                                <td>
                                    ...
                                    <textarea name="buckedPer" readOnly={true}
                                              className="formField per" value={this.state.buckedPer}/>
                            ...
                            <tr className={this.state.bucked ? 'row' : 'row hidden'}>
                                <td>
                                    ...
                                    <input type="number" name="qc" value={this.state.qc} className="formField"
                                           onChange={this.fieldChange}/>
                                </td>
                                <td>
                                    <div>
                                        ...
                                        <textarea name="qcPer" className="formField per" readOnly={true}
                            ...
                            <tr className={this.state.qc ? 'row' : 'row hidden'}>
                                <td>
                                    ...
                                    <input type="number" name="bio" value={this.state.bio} className="formField"
                                           onChange={this.fieldChange}/>
                                </td>
                                <td>
                                    <div>
                                        ...
                                        <textarea name="bioPer" className="formField per" readOnly={true}
                            ...
                            <tr className={this.state.bio ? 'row' : 'row hidden'}>
                                <td>
                                    ...
                                    <input type="number" name="bBud" value={this.state.bBud} className="formField"
                                           onChange={this.fieldChange}/>
                                </td>
                                <td>
                                    <div>
                                        ...
                                        <textarea name="bBudPer" className="formField per" unselectable="true"
                                                  readOnly={true}
                            ...
                            <tr className={this.state.bBud ? 'row' : 'row hidden'}>
                                ...
                                <td>
                                    <div className="blinker">
                                        ...
                                        <textarea name="final" className="formField per final" unselectable={"true"}
                                                  readOnly={true}
